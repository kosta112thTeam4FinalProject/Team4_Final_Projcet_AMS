...
public class AnonymousController {
	...
	public String anonymous_list_View(String pg, Model model) throws ClassNotFoundException, SQLException
	{
		System.out.println("Con_익명게시판 목록보기 실행");	
		
		HashMap maps = anonymousService.getAllAnonymousList(pg);
	...
	public String anonymous_comment_list_View(String pg, Model model) throws ClassNotFoundException, SQLException
	{
		System.out.println("Con_익명게시판 댓글 목록보기 실행");	
		
		HashMap maps = anonymousService.getAllAnonyCommentList(pg);
