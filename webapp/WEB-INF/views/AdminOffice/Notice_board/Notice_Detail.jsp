...
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
	       	...
	       	<table>
				<tr>
					...
					<td colspan="2" class="right">
					 <button><a href="notice_modify.ams">수정</a></button>
					 <button><a href="notice_delete.ams">삭제</a></button></td>
				</tr>
				<tr>
				...
				<tr>
					<td class="right" colspan="6">
					  <button><a href="notice_rewrite.ams">답글</a></button>
						<button><a href="notice_list.ams">목록</a></button>
					</td>
	      ...
	      <div id="reply_write">
	        ...
	        <input type="hidden" name="idx" value="${notice.reply_write }"> <!-- 내가 현재 reply을 다려는 글 번호를 알아야 함!  -->
	      	<table>
	      		<tr>
