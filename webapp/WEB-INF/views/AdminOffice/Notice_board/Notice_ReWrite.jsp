...
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
	      ...
	      <form action="notice_rewrite.ams" id="" method="post" enctype="multipart/form-data">
			...
			<input type="hidden" name="noti_idx" value="" /> <!-- 글번호  -->
	       	<table>
				...
				<tr>
					<th>제목</th>
					<td colspan="5">
						<input type="text" name="noti_title" id="" value="[Re]test${notice.noti_title}" >
					</td>
				</tr>
				<tr>
				 	<td colspan="6"><textarea id="" name="" cols="100" rows="15" >
				 	원본글의 내용이 보여질 예정${notice.noti_content}</textarea></td> 
				</tr>
				<tr>
